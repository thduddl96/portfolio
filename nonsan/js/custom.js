$(function () {
  ...
  $(".MainCategory .tab_menu>li>a").on("click", function (e) {
    ...
    $(".MainCategory .tab_content .slide_arrows .left").on(
      "click",
      function () {
        MAIN_CATE_SLIDE.slidePrev();
      }
    );
    $(".MainCategory .tab_content .slide_arrows .right").on(
      "click",
      function () {
  ...
  const ONLINE_CONTENT_SLIDE = new Swiper(
    ".MainContent .online_content_slide",
    {
      loop: true,
      effect: "fade",
      pagination: {
  ...
  $(".MainContent .online_content .slide_arrows .left").on(
    "click",
    function () {
      ONLINE_CONTENT_SLIDE.slidePrev();
    }
  );
  $(".MainContent .online_content .slide_arrows .right").on(
    "click",
    function () {
